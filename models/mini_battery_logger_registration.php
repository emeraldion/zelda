<?php
	...
	require_once(dirname(__FILE__) . "/../helpers/mini_battery_logger_license.php");
	
	/**
	 *	@class MiniBatteryLoggerRegistration
	 *	@short Model object for registrations of the MiniBatteryLogger application.
	 ...
	 */
	class MiniBatteryLoggerRegistration extends Registration
	{
		// All registrations should go in the same table.
		// 'Single table inheritance'?
		protected $table_name = 'registrations';

		protected $license_class = 'MiniBatteryLoggerLicense';
